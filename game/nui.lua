...
RegisterNUICallback("appearance_change_component", function(component, cb)
    client.setPedComponent(PlayerPedId(), component)
    cb(client.getComponentSettings(PlayerPedId(), component.component_id))
end)

RegisterNUICallback("appearance_change_prop", function(prop, cb)
    client.setPedProp(PlayerPedId(), prop)
    cb(client.getPropSettings(PlayerPedId(), prop.prop_id))
end)
...
RegisterNUICallback("appearance_change_hair", function(hair, cb)
    ...
    cb(client.getHairSettings(PlayerPedId()))
end)
