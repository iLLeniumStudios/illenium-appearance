...
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector4(1693.92, 4830.82, 42.07, 250), width = 4, length = 4, showBlip = true}, -- showBlip overrides the blip visibilty configured above for the group
...
Config.ClothingRooms = {
    [1] = {requiredJob = "police", isGang = false, coords = vector4(463.43, -999.07, 30.69), width = 3, length = 3},
    --[2] = {requiredJob = "police", isGang = false, coords = vector4(454.43, -988.85, 30.69), width = 2, length = 2},
    [2] = {requiredJob = "police", isGang = false, coords = vector4(301.3, -599.04, 43.28), width = 3, length = 3}, -- Right double door in Hospital Map that is on QBCore GitHub
    --[3] = {requiredJob = "police", coords = vector4(314.76, 671.78, 14.73)},
    --[3] = {requiredJob = "ambulance", coords = vector4(338.70, 659.61, 14.71)},    
    --[4] = {requiredJob = "ambulance", coords = vector4(-1098.45, 1751.71, 23.35)},    
    --[6] = {requiredJob = "police", coords = vector4(-77.59, -129.17, 5.03)},
}
...
--[[
    [1] = {
        coords = vector4(287.29, -573.41, 43.17),
        width = 3,
        length = 3,
        citizenIDs = {
            "BHH65156",
